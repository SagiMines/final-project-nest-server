  ...
  async canActivate(
    ...
    if (found) {
      ...
      if (arePasswordsTheSame) {
        ...
        context.switchToHttp().getResponse().cookie('user_id', encryptedUserId.toString(), {domain: '.herokuapp.com', secure: true, maxAge: 365*24*60*60*1000, httpOnly: false, sameSite: 'none'})
